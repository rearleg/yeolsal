...
class SurvivalStateRosterIT {
    ...
    @WithMockUser(username = "bob-rosterit@example.com")
    ...
    @WithMockUser(username = "alice-rosterit@example.com")
    ...
    @WithMockUser(username = "carol-rosterit@example.com")
    ...
    @WithMockUser(username = "dave-rosterit@example.com")
